...
const Problem: React.FC = () => {
  ...
  return (
    <section id="problem" className="py-16 md:py-20 lg:py-24 bg-white">
      <div className="container-custom">
        <div className="content-max">
          <SlideUp>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-[var(--color-slate-900)] mb-8 md:mb-12 ">
              ¿Te suena familiar?
            </h2>
          </SlideUp>
