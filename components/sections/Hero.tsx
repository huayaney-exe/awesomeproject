...
const Hero: React.FC = () => {
  ...
  return (
    <GradientBackground parallax className="min-h-screen flex items-center justify-center py-16 md:py-20">
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <FadeIn delay={0.2}>
            <p className="text-base md:text-lg lg:text-xl text-white/80 mb-3 md:mb-4 max-w-2xl mx-auto">
              Para empresas B2B en Perú
            </p>
          </FadeIn>

          <FadeIn delay={0.4}>
            <p className="text-sm md:text-base lg:text-lg text-white/70 mb-8 md:mb-12 max-w-2xl mx-auto leading-relaxed">
